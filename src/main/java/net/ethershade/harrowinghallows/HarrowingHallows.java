...
import net.ethershade.harrowinghallows.component.ModDataComponentTypes;
import net.ethershade.harrowinghallows.item.ModCreativeModeTabs;
...
public class HarrowingHallows {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        if(event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
            event.accept(ModBlocks.STYXITE_BLOCK);
            event.accept(ModBlocks.RAW_STYXITE_BLOCK);
        }
    }
